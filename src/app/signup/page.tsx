...
import { Loader2, Scissors, Mail, Lock, Eye, EyeOff, User } from "lucide-react";
  ...
  return (
    <div className="w-full relative z-20">
      ...
      <p className="mt-8 text-center text-[14px] text-gray-500 dark:text-gray-400">
        ...
        <Link href="/login" className="font-semibold text-[#111118] dark:text-white hover:text-[#7C5CFC] transition-colors outline-none focus-visible:underline">
          Sign in
        </Link>
      </p>
    </div>
