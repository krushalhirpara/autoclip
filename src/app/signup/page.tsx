  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#F8F9FC] p-6 dark:bg-[#0A0A0C]">
      <div className="w-full max-w-md rounded-[2.5rem] border border-[#E8E7F0] bg-white p-8 shadow-xl dark:border-[#27272A] dark:bg-[#141416] sm:p-12">
        ...
        <h1 className="text-center text-2xl font-bold text-[#111118] dark:text-white">Create an account</h1>
        <p className="mt-2 text-center text-sm text-[#6B6B78] dark:text-[#A1A1AA]">Start your 14-day free trial on AutoClipp account</p>
        ...
        <p className="mt-6 text-center text-sm text-[#6B6B78] dark:text-[#A1A1AA]">
          Already have an account? <Link href="/login" className="font-semibold text-[#111118] hover:text-[#7C5CFC] dark:text-white">Log in</Link>
        </p>
      </div>
    </main>
  );
