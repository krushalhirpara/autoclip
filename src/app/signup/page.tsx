  ...
  return (
    <div className="w-full">
      ...
      <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
        <div>
          <label className="text-sm font-medium text-[#111118] dark:text-[#E4E4E7]">Full Name</label>
          <input 
            type="text" 
            required
            value={name}
      ...
      <p className="mt-8 text-center text-sm text-[#6B6B78] dark:text-[#A1A1AA]">
        ...
        <Link href="/login" className="font-semibold text-[#111118] hover:text-[#7C5CFC] dark:text-white dark:hover:text-[#A78BFA] transition-colors">
          Sign in
        </Link>
      </p>
    </div>
