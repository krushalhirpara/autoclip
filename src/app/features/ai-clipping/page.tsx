      ...
      <div className="w-full flex flex-col space-y-4">
        ...
        <div className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 relative">
            ...
            {["Upload Long-form","AI Analysis","Hook Detection","Clip Selection","Export"].map((step, idx, arr) => (
        ...
        <div className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[{"title":"Retention-Optimized","desc":"Our AI analyzes speech patterns and energy levels to extract clips mathematically proven to retain attention."},{"title":"Batch Processing","desc":"Generate 15-30 ready-to-post clips from a single 1-hour podcast episode in just a few minutes."},{"title":"Viral Score","desc":"Every generated clip is assigned a virality score, helping you decide which ones to post first."}].map((benefit, idx) => (
