      ...
      <div className="w-full h-full flex items-center justify-center flex-col">
        ...
        <div className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 relative">
            ...
            {["AI Transcription","Word-by-word sync","Style Selection","Highlight Words","Render"].map((step, idx, arr) => (
        ...
        <div className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[{"title":"99% Accuracy","desc":"Industry-leading transcription models ensure your captions are perfectly accurate in 50+ languages."},{"title":"Hormozi Style","desc":"Apply popular creator caption styles instantly, complete with emojis, highlights, and animations."},{"title":"Auto-Emojis","desc":"Context-aware AI automatically inserts relevant emojis to match spoken words."}].map((benefit, idx) => (
