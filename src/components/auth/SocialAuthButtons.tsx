...
export function SocialAuthButtons() {
  ...
  return (
    <div className="flex flex-col space-y-3 w-full mt-8">
      ...
      <Button 
        variant="outline" 
        className="w-full h-12 flex items-center justify-center space-x-2 border-[#E8E7F0] bg-white hover:bg-[#F4F3FF] dark:border-[#27272A] dark:bg-[#141416] dark:hover:bg-[#1B1B1F] text-[#111118] dark:text-white font-medium rounded-xl transition-colors"
